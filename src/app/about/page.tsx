...
export default function AboutPage() {
  return (
    <motion.main initial={{ opacity: 0, x: -100 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.25 } }} className="mx-auto my-16 sm:my-48 mb-16 sm:mb-0 max-w-2xl lg:max-w-3xl">
      <Brief
        heading={
          <>
      ...
      <p className="mx-6 sm:mx-0 mt-6 text-base text-zinc-700">Feel free to reach out to me with any inquiries or collaboration possibilities. I&apos;m eager to meet new people and make connections!</p>
      <div className="flex justify-evenly sm:justify-start mx-6 sm:mx-0 gap-0 sm:gap-4 mt-6">
        <Button href={socials.linkedin} icon={<FaLinkedinIn className="h-4 w-4" />} text="LinkedIn"></Button>
        <Button href={socials.github} icon={<FaGithub className="h-5 w-5" />} text="GitHub"></Button>
      </div>
    </motion.main>
  );
}
