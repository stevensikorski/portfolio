...
export default function Home() {
  return (
    <motion.main initial={{ opacity: 0, x: -100 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.25 } }} className="mx-auto my-16 sm:my-48 max-w-2xl lg:max-w-3xl">
      ...
      <div className="flex justify-evenly sm:justify-start mx-6 sm:mx-0 gap-0 sm:gap-4">
        <Button href="/Steven_Sikorski_Resume.pdf" icon={<FaFilePdf className="h-4 w-4" />} text="Resume"></Button>
        <Button href="/contact" icon={<TbMessageCircle2Filled className="h-5 w-5" />} text="Contact"></Button>
      </div>
    </motion.main>
  );
}
